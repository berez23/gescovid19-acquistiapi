...
public interface BaseStrutturaMapper {
	 ...
	 * @mbg.generated
	 */
	@Insert({ "insert into struttura (id_struttura, id_ente, ", "nome, natura, indirizzo, ", "comune_istat)",
			"values (#{idStruttura,jdbcType=VARCHAR}, #{idEnte,jdbcType=INTEGER}, ",
			"#{nome,jdbcType=VARCHAR}, #{natura,jdbcType=VARCHAR}, #{indirizzo,jdbcType=VARCHAR}, ",
			"#{comuneIstat,jdbcType=VARCHAR})" })
