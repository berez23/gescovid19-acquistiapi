...
java -cp %SWAGGER_CP% %DEBUG_OPTS% io.swagger.codegen.SwaggerCodegen generate -i ..\src\yaml\acquisto-beni.yaml -l jaxrs-resteasy-eap-csi -o .. --config swagger_config_java_acquisto-beni.json

rem echo
rem pause "#### generazione stub angular2 ####"
rem java -cp %SWAGGER_CP% %DEBUG_OPTS% io.swagger.codegen.SwaggerCodegen generate -i ..\src\yaml\acquisto-beni.yaml -l typescript-angular -o ..\..\acquistobeniapi --config swagger_config_angular.json 
